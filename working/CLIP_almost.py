...
def basetree(data, basedate):
    ...
    print(len(data3))
#    ward = DBSCAN(eps=2.4, algorithm = "kd_tree",min_samples = dlen).fit(data5)
#    ward = DBSCAN(eps=2.2, algorithm = "kd_tree",leaf_size=3, min_samples=5).fit(data5)
    ward = MeanShift(bandwidth=None, seeds=None, bin_seeding=False, min_bin_freq=3, cluster_all=True, n_jobs=2).fit(data5)
...
#    print(dlen)
    ...
    dt = DecisionTreeClassifier(criterion = "entropy",random_state = 492356, min_samples_split=6, min_samples_leaf = dlen)
    data4 = data3
    #criterion = "entropy",
        ...
        if bt.n_classes_ <=2:
            ...
            try:
                ...
                if date == basedate:
                    ...
                    basestructure.to_csv("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basestructure")
                    basedclust = applydecisiontree(data2,basedate,pd.read_csv("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basestructure"))
                    basedclust.to_csv("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basedclust")
                clust = applydecisiontree(data2,date,pd.read_csv("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basestructure"))
                new = pd.DataFrame()
                new = geo(clust, geobase(pd.read_csv("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basedclust")))
            #print("CLIP")
                bbb["type"] = "CLIP"
            except:
                new = jevons(pd.DataFrame(data),date,basedate)
...
def runthrough(data,basedate):
    ...
    os.remove("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basestructure")
    os.remove("/media/mint/e834712c-23da-4cbe-a4ec-3a35d416877b/Run_system/Data/basedclust")
